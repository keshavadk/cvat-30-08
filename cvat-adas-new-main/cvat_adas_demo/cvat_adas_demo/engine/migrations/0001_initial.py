# Generated by Django 3.1.13 on 2021-08-27 11:01

import cvat_adas_demo.engine.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compressed_chunk_type', models.CharField(choices=[('video', 'VIDEO'), ('imageset', 'IMAGESET'), ('list', 'LIST')], default=cvat_adas_demo.engine.models.DataChoice['IMAGESET'], max_length=32)),
                ('original_chunk_type', models.CharField(choices=[('video', 'VIDEO'), ('imageset', 'IMAGESET'), ('list', 'LIST')], default=cvat_adas_demo.engine.models.DataChoice['IMAGESET'], max_length=32)),
                ('storage_method', models.CharField(choices=[('cache', 'CACHE'), ('file_system', 'FILE_SYSTEM')], default=cvat_adas_demo.engine.models.StorageMethodChoice['FILE_SYSTEM'], max_length=15)),
                ('storage', models.CharField(choices=[('cloud_storage', 'CLOUD_STORAGE'), ('local', 'LOCAL'), ('share', 'SHARE')], default=cvat_adas_demo.engine.models.StorageChoice['LOCAL'], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('annotation', 'ANNOTATION'), ('validation', 'VALIDATION'), ('completed', 'COMPLETED')], default=cvat_adas_demo.engine.models.StatusChoice['ANNOTATION'], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', cvat_adas_demo.engine.models.SafeCharField(max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points', cvat_adas_demo.engine.models.FloatArrayField()),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='engine.job')),
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='engine.label')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', cvat_adas_demo.engine.models.SafeCharField(max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('annotation', 'ANNOTATION'), ('validation', 'VALIDATION'), ('completed', 'COMPLETED')], default=cvat_adas_demo.engine.models.StatusChoice['ANNOTATION'], max_length=32)),
                ('dimension', models.CharField(choices=[('3d', 'DIM_3D'), ('2d', 'DIM_2D')], default=cvat_adas_demo.engine.models.DimensionType['DIM_2D'], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('value', cvat_adas_demo.engine.models.SafeCharField(max_length=4096)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('frame', models.PositiveIntegerField()),
                ('position', cvat_adas_demo.engine.models.FloatArrayField()),
                ('created_date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('path', models.FileField(max_length=1024, storage=cvat_adas_demo.engine.models.MyFileSystemStorage(), upload_to=cvat_adas_demo.engine.models.upload_path_handler)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=1024, storage=cvat_adas_demo.engine.models.MyFileSystemStorage(), upload_to=cvat_adas_demo.engine.models.upload_path_handler)),
