...
from cvat_adas_demo.restrictions.views import RestrictionsViewSet
from cvat_adas_demo.authentication.decorators import login_required
from cvat_adas_demo.training.views import PredictView
from cvat_adas_demo.engine.views import UserViewSet

schema_view = get_schema_view(
   openapi.Info(
      title="CVAT REST API",
      default_version='v1',
      description="REST API for ADAS Annotation Tool",
...
urlpatterns = [
    ...
    # entry point for API
    path('api/v1/auth/', include('cvat_adas_demo.authentication.urls')),
    path('api/v1/', include((router.urls, 'cvat_adas_demo'), namespace='v1')),
