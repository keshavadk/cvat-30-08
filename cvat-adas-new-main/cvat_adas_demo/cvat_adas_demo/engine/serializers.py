...
from cvat_adas_demo.dataset_manager.formats.utils import get_label_color
from cvat_adas_demo.engine import models
from cvat_adas_demo.engine.cloud_provider import get_cloud_storage_instance, Credentials
from cvat_adas_demo.engine.log import slogger
...
class UserSerializer(serializers.ModelSerializer):
    groups = serializers.SlugRelatedField(many=True,
        ...
        #slug_field='username', queryset=Group.objects.all())
